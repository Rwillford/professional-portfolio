    ...
    return (
        <section className="my-5">
            ...
            <p>Hello, my name is Robert Willford but you can just call me Bob. I'm the son of an IT technician.<br></br>
               ...
               I'm currently enrolled at the University of Minnesota Coding Bootcamp where I after completion I will purse the career of becoming a full stack developer.<br></br>
            </p>
        </section>
    )
}
